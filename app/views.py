...
from .models import Contact, ContactGroup, Gender, vyrobce, typ_vozidla, motor
...
class typVozidlaView(ModelView):
    datamodel = SQLAInterface(typ_vozidla)

class motorView(ModelView):
    datamodel = SQLAInterface(motor)
